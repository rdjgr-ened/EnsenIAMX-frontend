      ...
      <div className="max-w-5xl mx-auto w-full px-4 sm:px-6 mt-8 print:max-w-none print:px-0 print:mt-0">
          ...
          <div className="py-32 flex flex-col items-center justify-center text-center space-y-4">
            ...
            <div>
              ...
              <p className="text-sm text-slate-500 max-w-md mx-auto mt-2">
                Diseñando la matriz de criterios para "{instrumentName}" con total coherencia al PDA.
              </p>
            </div>
          </div>
        )}
        ...
        {instrumentData && !isLoading && (
          <div className="space-y-6">
            ...
            <div id="instrumento-evaluacion-resultado" className="bg-white p-6 sm:p-10 rounded-2xl border-2 border-slate-900 shadow-sm font-sans text-slate-900 space-y-8 printable-document print:border-none print:shadow-none print:p-0">
                      ...
                      <tbody>
                        {instrumentData.itemsListaCotejo.map((item, idx) => (
                          <tr key={idx} className={idx % 2 === 0 ? "bg-white" : "bg-slate-50"} style={{pageBreakInside: 'avoid'}}>
                            ...
                            <td className="border border-slate-900 p-3 text-center">
                              <div className="w-5 h-5 border-2 border-slate-900 mx-auto rounded-sm"></div>
                            </td>
                            <td className="border border-slate-900 p-3 text-center">
                              <div className="w-5 h-5 border-2 border-slate-900 mx-auto rounded-sm"></div>
                            </td>
