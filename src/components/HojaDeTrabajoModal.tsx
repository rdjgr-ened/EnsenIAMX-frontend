  ...
  return (
    ...
    <div className="w-full min-h-screen bg-slate-50 pb-16 animate-fade-in print:bg-white print:pb-0 print:m-0">
        ...
        {worksheet && !isLoading && (
          <div className="space-y-6">
            ...
            <div id="hoja-trabajo-resultado"
              className="bg-white p-6 sm:p-12 rounded-2xl border border-slate-300 shadow-sm space-y-8 text-slate-900 text-xs printable-document print:border-none print:shadow-none print:p-0"
            >
              ...
              <div className="border-2 border-slate-900 rounded-xl p-5 bg-slate-50/50 space-y-4">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 text-xs pt-3 border-t border-slate-300">
                  ...
                  <div className="p-3 bg-white rounded border border-slate-200">
                    ...
                    <span className="block pt-1 border-b border-slate-400 mt-2"></span>
                  </div>
                  <div className="p-3 bg-white rounded border border-slate-200">
      ...
      <style dangerouslySetInnerHTML={{ __html: `
        /* 
         * ESTE CSS GLOBAL SE ACTIVA CUANDO SE ABRE LA HOJA DE TRABAJO.
