        ...
        <div className="space-y-6 animate-fade-in">
          ...
          {selectedCategory === "plano" && (
            <div className="space-y-4">
              ...
              {/* AQUÍ ESTÁN LOS BOTONES (Incluyendo el de Proyectos de Aula) */}
              <div className="grid grid-cols-1 md:grid-cols-2 gap-5 pt-2">
                ...
                {/* 2. BOTÓN NUEVO: PROYECTOS DE AULA */}
                <div 
                  onClick={() => handleFunctionClick("proyectos_aula")} 
                  className="group cursor-pointer bg-white border-2 border-blue-600/20 hover:border-blue-600 rounded-2xl p-6 shadow-sm hover:shadow-md transition flex flex-col justify-between relative overflow-hidden"
                >
                  <div className="absolute top-3 right-3 flex items-center gap-1 text-[10px] font-black bg-amber-100 text-amber-900 px-2 py-0.5 rounded-full">
                    <Coins className="w-3 h-3" /> 10 créditos
                  </div>
                ...
                <div 
                  ...
                  className="group cursor-pointer bg-white border border-slate-200 hover:border-indigo-600 rounded-2xl p-6 shadow-sm hover:shadow-md transition flex flex-col justify-between relative overflow-hidden"
                >
                  <div className="absolute top-3 right-3 flex items-center gap-1 text-[10px] font-black bg-amber-100 text-amber-900 px-2 py-0.5 rounded-full">
                  ...
                  <div className="space-y-3">
                    ...
                    <p className="text-slate-500 text-xs font-semibold">
                      Genera una hoja de trabajo lista para imprimir. Selecciona cualquier sesión de tus planeaciones y diseña ejercicios.
                    </p>
                  </div>
                ...
                {/* 4. CREAR INSTRUMENTO DE EVALUACIÓN */}
                <div 
