...
interface DashboardHubProps {
  onSelectFunction: (
    fn: "diseno" | "sugerir" | "crear" | "programa" | "evaluacion" | "bitacora" | "organizador",
...
export default function DashboardHub({ onSelectFunction, savedPlansCount, docenteName }: DashboardHubProps) {
        ...
        <div className="space-y-6 animate-fade-in">
          ...
          {selectedCategory === "organizador" && (
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 pt-2">
                <div
                  onClick={() => onSelectFunction("organizador", "planeaciones")}
                ...
                <div
                  onClick={() => onSelectFunction("organizador", "grupos")}
                  className="group cursor-pointer bg-white border border-slate-200 hover:border-blue-600 p-5 rounded-xl shadow-sm hover:shadow-md transition flex flex-col justify-between"
                >
                  <div>
                ...
                <div
                  onClick={() => onSelectFunction("organizador", "bitacora")}
                  className="group cursor-pointer bg-white border border-slate-200 hover:border-rose-600 p-5 rounded-xl shadow-sm hover:shadow-md transition flex flex-col justify-between"
                >
                  <div>
                ...
                <div
                  onClick={() => onSelectFunction("organizador", "seguimiento")}
                  className="group cursor-pointer bg-white border border-slate-200 hover:border-emerald-600 p-5 rounded-xl shadow-sm hover:shadow-md transition flex flex-col justify-between"
                >
                  <div>
                ...
                <div
                  onClick={() => onSelectFunction("organizador", "evaluacion")}
                  className="group cursor-pointer bg-white border border-slate-200 hover:border-amber-600 p-5 rounded-xl shadow-sm hover:shadow-md transition flex flex-col justify-between"
                >
                  <div>
                    <h4 className="font-extrabold text-slate-800 text-sm">5. Evaluación Continua del Trabajo en Clase</h4>
                  </div>
          ...
          {selectedCategory === "plano" && (
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5 pt-2">
                <div 
                  onClick={() => onSelectFunction("diseno")}
                  className="group cursor-pointer bg-white border-2 border-mex-maroon/20 hover:border-mex-maroon rounded-2xl p-6 shadow-sm hover:shadow-md transition flex flex-col justify-between"
                >
          ...
          {selectedCategory === "programa" && (
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5 pt-2">
                <div 
                  onClick={() => onSelectFunction("sugerir")}
                  className="group cursor-pointer bg-white border border-slate-200 hover:border-amber-400 rounded-2xl p-6 shadow-sm hover:shadow-md transition flex flex-col justify-between"
                >
                  <div className="space-y-3">
                ...
                <div 
                  onClick={() => onSelectFunction("crear")}
                  className="group cursor-pointer bg-white border border-slate-200 hover:border-mex-maroon/40 rounded-2xl p-6 shadow-sm hover:shadow-md transition flex flex-col justify-between"
                >
                  <div className="space-y-3">
                ...
                <div 
                  onClick={() => onSelectFunction("programa")}
                  className="group cursor-pointer bg-white border border-slate-200 hover:border-mex-maroon/40 rounded-2xl p-6 shadow-sm hover:shadow-md transition flex flex-col justify-between"
                >
                  <div className="space-y-3">
                    <div className="w-10 h-10 rounded-xl bg-mex-maroon/5 text-mex-maroon flex items-center justify-center">
          ...
          {selectedCategory === "evaluacion" && (
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5 pt-2">
                <div 
                  onClick={() => onSelectFunction("evaluacion")}
                  className="group cursor-pointer bg-white border border-emerald-200 hover:border-emerald-500 rounded-2xl p-6 shadow-sm hover:shadow-md transition flex flex-col justify-between"
                >
                  <div className="space-y-3">
          ...
          {selectedCategory === "gestion" && (
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5 pt-2">
                <div 
                  onClick={() => onSelectFunction("bitacora")}
                  className="group cursor-pointer bg-white border border-rose-200 hover:border-mex-maroon rounded-2xl p-6 shadow-sm hover:shadow-md transition flex flex-col justify-between"
                >
                  <div className="space-y-3">
                ...
                <div 
                  onClick={() => onSelectFunction("organizador", "grupos")}
                  className="group cursor-pointer bg-white border border-slate-200 hover:border-blue-600 rounded-2xl p-6 shadow-sm hover:shadow-md transition flex flex-col justify-between"
                >
                  <div className="space-y-3">
