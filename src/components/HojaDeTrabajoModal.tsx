...
export default function HojaDeTrabajoModal(props: HojaDeTrabajoModalProps) {
  ...
  return (
    <div id="hoja-trabajo-modal-wrapper" className="fixed inset-0 bg-slate-900/70 backdrop-blur-xs flex items-center justify-center p-3 sm:p-6 z-50 animate-fade-in overflow-y-auto print:absolute print:inset-auto print:top-0 print:left-0 print:block print:w-full print:bg-transparent print:p-0 print:m-0 print:opacity-100 print:animate-none">
      <div className="bg-white rounded-2xl max-w-4xl w-full max-h-[92vh] flex flex-col shadow-2xl border border-slate-200 overflow-hidden print:max-w-none print:w-full print:max-h-none print:h-auto print:shadow-none print:border-none print:rounded-none print:overflow-visible print:block">
        {/* Modal Header */}
        ...
        {/* Modal Body */}
        <div className="p-6 overflow-y-auto grow space-y-6 bg-slate-50 print:p-0 print:bg-white print:overflow-visible print:block print:h-auto">
          {isLoading && (
          ...
          {worksheet && !isLoading && (
            <div className="space-y-4">
              ...
              <div id="hoja-trabajo-resultado"
                className="bg-white p-8 rounded-2xl border border-slate-300 shadow-sm space-y-6 text-slate-900 text-xs printable-document print:p-0 print:shadow-none print:border-none"
              >
