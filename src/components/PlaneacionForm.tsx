...
// Diccionario de IDs infalible analizado directamente desde el CSV
const NEM_ID_RANGES: Record<string, {min: number, max: number}> = {
  "Fase 2_1°_De lo Humano y lo Comunitario": { min: 1, max: 8 },
  "Fase 2_1°_Lenguajes": { min: 9, max: 17 },
  "Fase 2_1°_Saberes y Pensamiento Científico": { min: 18, max: 26 },
  "Fase 2_1°_Ética, Naturaleza y Sociedades": { min: 27, max: 34 },
  "Fase 2_2°_De lo Humano y lo Comunitario": { min: 35, max: 42 },
  "Fase 2_2°_Lenguajes": { min: 43, max: 52 },
  "Fase 2_2°_Saberes y Pensamiento Científico": { min: 53, max: 61 },
  "Fase 2_2°_Ética, Naturaleza y Sociedades": { min: 62, max: 69 },
  "Fase 2_3°_De lo Humano y lo Comunitario": { min: 70, max: 77 },
  "Fase 2_3°_Lenguajes": { min: 78, max: 87 },
  "Fase 2_3°_Saberes y Pensamiento Científico": { min: 88, max: 96 },
  "Fase 2_3°_Ética, Naturaleza y Sociedades": { min: 97, max: 104 },
  "Fase 3_1°_De lo Humano y lo Comunitario": { min: 105, max: 124 },
  "Fase 3_1°_Lenguajes": { min: 125, max: 150 },
  "Fase 3_1°_Saberes y Pensamiento Científico": { min: 151, max: 165 },
  "Fase 3_1°_Ética, Naturaleza y Sociedades": { min: 166, max: 183 },
  "Fase 3_2°_De lo Humano y lo Comunitario": { min: 184, max: 203 },
  "Fase 3_2°_Lenguajes": { min: 204, max: 229 },
  "Fase 3_2°_Saberes y Pensamiento Científico": { min: 230, max: 245 },
  "Fase 3_2°_Ética, Naturaleza y Sociedades": { min: 246, max: 263 },
  "Fase 4_3°_De lo Humano y lo Comunitario": { min: 264, max: 283 },
  "Fase 4_3°_Lenguajes": { min: 284, max: 308 },
  "Fase 4_3°_Saberes y Pensamiento Científico": { min: 309, max: 326 },
  "Fase 4_3°_Ética, Naturaleza y Sociedades": { min: 327, max: 344 },
  "Fase 4_4°_De lo Humano y lo Comunitario": { min: 345, max: 364 },
  "Fase 4_4°_Lenguajes": { min: 365, max: 389 },
  "Fase 4_4°_Saberes y Pensamiento Científico": { min: 390, max: 407 },
  "Fase 4_4°_Ética, Naturaleza y Sociedades": { min: 408, max: 425 },
  "Fase 5_5°_De lo Humano y lo Comunitario": { min: 426, max: 442 },
  "Fase 5_5°_Lenguajes": { min: 443, max: 466 },
  "Fase 5_5°_Saberes y Pensamiento Científico": { min: 467, max: 489 },
  "Fase 5_5°_Ética, Naturaleza y Sociedades": { min: 490, max: 509 },
  "Fase 5_6°_De lo Humano y lo Comunitario": { min: 510, max: 526 },
  "Fase 5_6°_Lenguajes": { min: 527, max: 550 },
  "Fase 5_6°_Saberes y Pensamiento Científico": { min: 551, max: 572 },
  "Fase 5_6°_Ética, Naturaleza y Sociedades": { min: 573, max: 592 },
  "Fase 6_1°_De lo Humano y lo Comunitario_Tecnología": { min: 593, max: 601 },
  "Fase 6_1°_De lo Humano y lo Comunitario_Tutoría / Educación Socioemocional": { min: 602, max: 607 },
  "Fase 6_1°_Lenguajes_Artes": { min: 608, max: 622 },
  "Fase 6_1°_Lenguajes_Español": { min: 623, max: 637 },
  "Fase 6_1°_Lenguajes_Inglés": { min: 638, max: 652 },
  "Fase 6_1°_Saberes y Pensamiento Científico_Biología": { min: 653, max: 662 },
  "Fase 6_1°_Saberes y Pensamiento Científico_Física": { min: 663, max: 668 },
  "Fase 6_1°_Saberes y Pensamiento Científico_Matemáticas": { min: 669, max: 683 },
  "Fase 6_1°_Ética, Naturaleza y Sociedades_Formación Cívica y Ética": { min: 684, max: 700 },
  "Fase 6_1°_Ética, Naturaleza y Sociedades_Geografía": { min: 701, max: 715 },
  "Fase 6_1°_Ética, Naturaleza y Sociedades_Historia": { min: 716, max: 726 },
  "Fase 6_2°_De lo Humano y lo Comunitario_Tecnología": { min: 727, max: 735 },
  "Fase 6_2°_De lo Humano y lo Comunitario_Tutoría / Educación Socioemocional": { min: 736, max: 741 },
  "Fase 6_2°_Lenguajes_Artes": { min: 742, max: 756 },
  "Fase 6_2°_Lenguajes_Español": { min: 757, max: 771 },
  "Fase 6_2°_Lenguajes_Inglés": { min: 772, max: 786 },
  "Fase 6_2°_Saberes y Pensamiento Científico_Física": { min: 787, max: 803 },
  "Fase 6_2°_Saberes y Pensamiento Científico_Matemáticas": { min: 804, max: 816 },
  "Fase 6_2°_Ética, Naturaleza y Sociedades_Formación Cívica y Ética": { min: 817, max: 833 },
  "Fase 6_2°_Ética, Naturaleza y Sociedades_Historia": { min: 834, max: 838 },
  "Fase 6_3°_De lo Humano y lo Comunitario_Tecnología": { min: 839, max: 847 },
  "Fase 6_3°_De lo Humano y lo Comunitario_Tutoría / Educación Socioemocional": { min: 848, max: 853 },
  "Fase 6_3°_Lenguajes_Artes": { min: 854, max: 868 },
  "Fase 6_3°_Lenguajes_Español": { min: 869, max: 883 },
  "Fase 6_3°_Lenguajes_Inglés": { min: 884, max: 898 },
  "Fase 6_3°_Saberes y Pensamiento Científico_Física": { min: 899, max: 904 },
  "Fase 6_3°_Saberes y Pensamiento Científico_Matemáticas": { min: 905, max: 914 },
  "Fase 6_3°_Saberes y Pensamiento Científico_Química": { min: 915, max: 927 },
  "Fase 6_3°_Ética, Naturaleza y Sociedades_Formación Cívica y Ética": { min: 928, max: 944 },
  "Fase 6_3°_Ética, Naturaleza y Sociedades_Historia": { min: 945, max: 950 }
};
...
export default function PlaneacionForm(props: PlaneacionFormProps) {
  ...
  const fetchCurriculumFromGemini = async (
    ...
    // 3. Not in cache: Perform lightweight API call
    ...
    // 🔴 LA SOLUCIÓN: Calcular la llave exacta para extraer los IDs del diccionario
    const gradoToNumMap: Record<string, string> = {
      "Primer Grado": "1°",
      "Segundo Grado": "2°",
      "Tercer Grado": "3°",
      "Cuarto Grado": "4°",
    ...
    const faseObj = getFaseByNivelGrado(targetNivel, targetGrado);
    const faseString = faseObj?.fase || "Fase 6";
    const gradoNum = gradoToNumMap[targetGrado] || targetGrado;

    // Normalizar a la llave del diccionario (Ignorando disciplina si es "General" o vacía)
    const rangeKey = disciplinaNombre && disciplinaNombre !== "General" 
      ? `${faseString}_${gradoNum}_${campoNombre}_${disciplinaNombre}` 
      : `${faseString}_${gradoNum}_${campoNombre}`;
      
    const ids = NEM_ID_RANGES[rangeKey];
